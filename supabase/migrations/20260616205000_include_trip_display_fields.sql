...
as $$
  select
    ...
    viagens.peso,
    viagens.peso_texto,
    coalesce(nullif(trim(viagens.peso_texto), ''), viagens.peso::text) as peso_exibicao,
    viagens.valor,
    viagens.dimensoes,
    viagens.tipo_veiculo,
    viagens.tipo_carroceria,
    viagens.categoria_carga,
    viagens.compatibilidade_veiculo,
